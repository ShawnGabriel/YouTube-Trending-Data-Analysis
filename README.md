...
Prior to beginning the analysis, a variety of checks were conducted for quality control and familiarization with the dataset. The SQL queries utilized to inspect and perform quality checks can be found [here.](https://github.com/ShawnGabriel/YouTube-Trending-Data-Analysis/blob/main/PySpark_YouTube_Trending_Data_Analysis.ipynb)
